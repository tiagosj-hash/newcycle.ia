    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            <p className="text-brand-300/70 text-sm font-semibold uppercase tracking-widest mb-4">
              Marketplace B2B com IA
            </p>
            <h2 className="text-4xl font-extrabold text-white leading-tight mb-6">
              Dê um novo ciclo<br />
              aos equipamentos<br />
              <span className="text-brand-300">da sua empresa</span>
            </h2>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 bg-white">
        ...
        >
          ...
          <p className="text-center text-sm text-gray-500">
            Não tem conta?{' '}
            <Link to="/cadastro" className="text-brand-600 font-semibold hover:text-brand-700 transition-colors">
